...
var user1 = new User('dhaubert.ti@gmail.com', 'fakePass921');
var adm1 = new Admin('dhaubert.ti@gmail.com', 'fakePass921');
console.log('User is admin?', user1.isAdmin());
console.log('Adm is admin?', adm1.isAdmin()); // #2
...
console.log('Ages', ages); // #2.2

var googler = users.filter(function (user) {
  return user.age >= 18 && user.company == 'Google';
});
console.log('Age and company: ', googler); // #2.3
